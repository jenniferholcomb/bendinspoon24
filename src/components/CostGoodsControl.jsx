...
const { tabCostGoodsWrapper, costGoodsWrapper, hiddenCostGoodsWrapper, costGoodsHeader, costLabelContainer, costLabel, infoIcon, controlContainer, costGoodsSubhead } = styles;
