...
const { tabCostGoodsWrapper, costGoodsWrapper, hiddenCostGoodsWrapper, costGoodsHeader, costLabelContainer, costLabel, infoIcon, infoIconSVG, controlContainer, costGoodsSubhead } = styles;
