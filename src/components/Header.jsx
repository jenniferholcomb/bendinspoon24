...
const { headerWrapper, logoContainer, logo, portraitContainer, subheadContainerPortrait, subheadContainerLandscape, locationContainer, town, about, pindrop, info } = styles;
  ...
  return (
    <>
      <div className={headerWrapper}>
        ...
        <h2 className={subheadContainerLandscape}>Forecasting</h2>
        <div className={portraitContainer}>
          <div className={locationContainer}>
            <h3 className={town}>Bend, Oregon</h3>
            <svg className={pindrop} xmlns="http://www.w3.org/2000/svg" width="10" height="13" viewBox="0 0 10 13" fill="none" cursor="default" >
          ...
          <h2 className={subheadContainerPortrait}>Forecasting</h2>
        </div>
      </div>
