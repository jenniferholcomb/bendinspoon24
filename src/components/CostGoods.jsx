...
const { costGoodsWrapper, costGoodsHeader, costLabelContainer, costLabel, infoIcon, infoIconSVG, greenArrow, redArrow, decreaseContainer, increaseContainer, goodsCard, decreasePercent, decreaseCost, decreaseCostContainer, percentSign, dollarSign, cents, decreaseItem, decreaseImg, costFooter, costGoodsSubhead } = styles;
