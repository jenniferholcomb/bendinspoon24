...
const { tabTourismWrapper, hiddenTourismWrapper, tourismWrapper, tourismHeader, tourismLabelContainer, tourismLabel, infoIcon, infoIconSVG, calendarContainer, tourismSubhead, calendarPage, calendarWrapper } = styles;
      ...
      <section className={isMobile ? (selectedTab === 'tourism' ? tabTourismWrapper : hiddenTourismWrapper) : tourismWrapper} aria-hidden={infoOpen ? "true" : "false"} aria-labelledby="tourism-label">
        <div className={tourismHeader}>
          <div className={tourismLabelContainer}>
            <h2 className={tourismLabel} id="tourism-label">Tourism Calendar</h2>
          </div>
          <div className={infoIcon}> 
            <button 
              onClick={() => onInfoInFocus("tourism")}
        ...
        <div className={calendarContainer}>
          <div className={calendarWrapper} role="grid">
            {percentLoaded && (
