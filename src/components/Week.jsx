          ...
          <div className={weekdayCardsContainer}>
            {thisWeek && (
              thisWeekUpdate.map((day, index) => 
                <div key={index} className={index === dayInFocus ? inFocusCard : isMobile ? cardHidden : dayCard} onClick={() => onChangingDay(index)}>
